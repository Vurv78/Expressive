...
---@field nodes Node[] # Mini-ASTs or the global ast, that are from code blocks
---@field ast Node[] # The AST generated by the parser.
...
local Transpilers = {
	...
	[NODE_KINDS.Index] = function(self, data)
		...
		local tbl = data[2]
		---@type Atom|Node
		local key  = data[3] -- A atom if it's a literal (x.0 or x.y), a node if it's a variable (x[y])
...
---@param ast Node[] # AST retrieved from the [Analyzer] or [Parser]
---@return string
